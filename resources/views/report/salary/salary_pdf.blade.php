...
<br>
 ...
 <table id="customers" style="font-size: 13px;">
                       ...
                       <thead>
                           <tr>
                            <th> <center>SALARY REPORTS FROM: {{$startDate}} TO:   {{$endDate}} </center></th>   
                           </tr>
                       </thead>
...
<tr style="color:green;">
       ...
       @foreach($data as $key=> $item)
            <tr>
                ...
                <td>{{$setting->currency}} {{ number_format($item->net_amount) }}</td>
            ...
            <tr>
                ...
                <td></td>
                <td> Total Salary</td>
                <td>  <strong>{{$setting->currency}} {{ number_format($totalSalary) }}</strong></td>
            </tr>
